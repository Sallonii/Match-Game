...
class Home extends Component {
  ...
  clickImageItem = imageUrl => {
    const {mainImg, score, isGameOver} = this.state
    const randomImgIndex = Math.floor(Math.random() * 30)
    ...
    this.setState({mainImg: imagesList[randomImgIndex].imageUrl})
  }
  ...
  render() {
    const {activeTabId, mainImg, score, isGameOver, timer} = this.state
      ...
      <div className="bg">
        ...
        {!isGameOver && (
          <div className="content-container">
            <img src={mainImg} alt="match" className="main-img" />
